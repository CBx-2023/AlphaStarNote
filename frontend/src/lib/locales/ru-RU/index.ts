export const ruRU = {
  ...
  connectionErrors: {
    ...
    apiDesc: "API-сервер Alpha-Note недоступен",
    ...
    docLink: "Документация Alpha-Note",
  ...
  settings: {
    ...
    filesHelp: "После загрузки и обработки файлы больше не нужны. Большинству пользователей следует разрешить Alpha-Note автоматически удалять загруженные файлы из папки загрузок.",
  ...
  advanced: {
    ...
    updateAvailableDesc: "Доступна новая версия Alpha-Note.",
  ...
  models: {
    ...
    defaultAssignmentsDesc: "Настройте, какие модели использовать для различных задач в Alpha-Note",
    missingRequiredModels: "Отсутствуют необходимые модели: {models}. Alpha-Note может работать некорректно без них.",
  ...
  apiKeys: {
    ...
    description: "Храните API-ключи в базе данных для безопасного подключения провайдеров ИИ в Alpha-Note.",
