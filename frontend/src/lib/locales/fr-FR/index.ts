export const frFR = {
  ...
  connectionErrors: {
    ...
    apiDesc: "Le serveur API de Alpha-Note est injoignable",
    ...
    docLink: "Documentation de Alpha-Note",
  ...
  settings: {
    ...
    filesHelp: "Une fois vos fichiers téléchargés et traités, ils ne sont plus nécessaires. La plupart des utilisateurs devraient autoriser Alpha-Note à supprimer automatiquement les fichiers du dossier de téléchargement.",
  ...
  advanced: {
    ...
    updateAvailableDesc: "Une nouvelle version de Alpha-Note est disponible.",
    upToDate: "À jour",
    unknown: "Inconnu",
  ...
  models: {
    ...
    defaultAssignmentsDesc: "Configurez quels modèles utiliser pour les différents usages d'Alpha-Note",
    missingRequiredModels: "Modèles requis manquants : {models}. Alpha-Note pourrait ne pas fonctionner correctement sans eux.",
  ...
  apiKeys: {
    ...
    description: "Stockez les clés API de manière sécurisée dans la base de données pour activer les fournisseurs d'IA dans Alpha-Note.",
