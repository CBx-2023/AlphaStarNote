export const enUS = {
  ...
  connectionErrors: {
    ...
    apiDesc: "The Alpha-Note API server could not be reached",
    ...
    docLink: "Alpha-Note Documentation",
  ...
  settings: {
    ...
    filesHelp: "Once your files are uploaded and processed, they are not required anymore. Most users should allow Alpha-Note to delete uploaded files from the upload folder automatically.",
  ...
  advanced: {
    ...
    updateAvailableDesc: "A new version of Alpha-Note is available.",
    upToDate: "Up to Date",
    unknown: "Unknown",
  ...
  models: {
    ...
    defaultAssignmentsDesc: "Configure which models to use for different purposes across Alpha-Note",
    missingRequiredModels: "Missing required models: {models}. Alpha-Note may not function properly without these.",
  ...
  apiKeys: {
    ...
    description: "Store API keys securely in the database to enable AI providers in Alpha-Note.",
