export const ptBR = {
  ...
  connectionErrors: {
    ...
    apiDesc: "O servidor da API do Alpha-Note não pôde ser alcançado",
    ...
    docLink: "Documentação do Alpha-Note",
  ...
  settings: {
    ...
    filesHelp: "Uma vez que seus arquivos são enviados e processados, eles não são mais necessários. A maioria dos usuários deve permitir que o Alpha-Note exclua arquivos enviados da pasta de upload automaticamente.",
  ...
  advanced: {
    ...
    updateAvailableDesc: "Uma nova versão do Alpha-Note está disponível.",
    upToDate: "Atualizado",
    unknown: "Desconhecido",
  ...
  models: {
    ...
    defaultAssignmentsDesc: "Configure quais modelos usar para diferentes propósitos no Alpha-Note",
    missingRequiredModels: "Modelos obrigatórios ausentes: {models}. O Alpha-Note pode não funcionar corretamente sem eles.",
  ...
  apiKeys: {
    ...
    description: "Armazene chaves de API com segurança no banco de dados para habilitar provedores de IA no Alpha-Note.",
