export const itIT = {
  ...
  connectionErrors: {
    ...
    apiDesc: "Il server API di Alpha-Note non è raggiungibile",
    ...
    docLink: "Documentazione Alpha-Note",
  ...
  settings: {
    ...
    filesHelp: "Una volta caricati ed elaborati, i tuoi file non sono più necessari. La maggior parte degli utenti dovrebbe permettere a Alpha-Note di eliminare automaticamente i file caricati dalla cartella upload.",
  ...
  advanced: {
    ...
    updateAvailableDesc: "È disponibile una nuova versione di Alpha-Note.",
    upToDate: "Aggiornato",
    unknown: "Sconosciuto",
  ...
  models: {
    ...
    defaultAssignmentsDesc: "Configura quali modelli usare per diversi scopi in Alpha-Note",
    missingRequiredModels: "Modelli richiesti mancanti: {models}. Alpha-Note potrebbe non funzionare correttamente senza questi.",
  ...
  apiKeys: {
    ...
    description: "Salva le chiavi API in modo sicuro nel database per abilitare i provider IA in Alpha-Note.",
